...
4 - SKT Themes Self Designed Images:
	...
	flower-shop-lite/images/icon-insta.png
...
Version 1.5
i)     Resolved sidebar heading styling issue 
ii)    Resolved Theme Check Issue.
iii)   Compatibility with WordPress 5.9
iv)    Resolved Theme Sniffer Issue.
v)     From header social icons replace Google Plus With Instagram.
vi)    Resolved header WooCommerce product cart quantity count issue.
